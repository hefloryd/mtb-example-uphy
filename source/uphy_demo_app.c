...
void uphy_task (void *)
{
   ...
   /* TBD - I think this shall be moved to porting layer or somehow automatically handled by lib.
    * For example when running Profinet DHCP shall not be initiated by configured ip used. */
